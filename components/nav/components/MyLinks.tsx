...
export const MyLinks = () => {
  return (
    <div className={styles.links}>
      ...
      >
        <Link href="https://www.linkedin.com/in/shakibul-islam-a910341b3/" target="_blank" rel="nofollow">
      ...
      >
        <Link href="https://github.com/MDShakibul" target="_blank" rel="nofollow">
